...
from flytesnacks.seldon.model_validation import test_asynchronous_feedback, validate_deployed_model
...
@task(cache=True, cache_version="1.2", requests=Resources(cpu="1", mem="500Mi"), limits=Resources(cpu="1", mem="500Mi"))
